    ...
    <div className='dark:bg-gray-950'>
        <div className="container">
            <div className="grid md:grid-cols-3 pb-20 pt-5">
                ...
                <p className='text-gray-600 dark:text-white/70 lg:pr-24 pt-3'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Soluta, dolore! Lorem ipsum dolor sit amet.</p>
                <p className='text-gray-500 mt-4'>Made with Shankar Jangid</p>
